// sir wala jo first day hua tha means 31/10/2022.
...
c = 0 // we dont need to initialize the type of variable here according to value it will be declear the variable type by default. 
//but we want to declear that is also fine.
if(c == 0) console.log("this values cantains 0");
